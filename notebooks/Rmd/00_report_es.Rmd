...
Falsas negativas 0.69. Relativo a lo mencionado, el Area bajo la curva (AUC) de
...
fueron los que aceptaron la proxima campaña. Se obtiene un recall de 0.31 y
precision de 0.77, siendo la habilidad para detectar los positivos reales y la
proporción de prediciones correctas en general respectivamente.

Arbol de decisión para Random Forest: ![](images/clipboard-1976038787.png)

### Gradient Boosting

Con Gradient Boosting en la precisión se obtienen menores valores para accuracy
y R2 (0.88; 0.88), pero así mismo la predicción parece ser más precisa
obteniendo un valor F1-score de 0.50 en comparación de 0.44 del Random forest,
mostrando que recall y precision son más equilibradas. El recall en este caso
es superior, de 0.40 mientras de disminuye la precision a 0.69. Se refleja en
la matriz de confusión que los Verdaderos Positivos y Falsos Positivos son 0.40
y 0.038 respectivamente, mientras que los Verdaderos Negativos y Falsos
Negativos son 0.96 y 0.59.

Importancia de las características según Gradient Boosting (con XGBoost):
![](images/clipboard-452312388.png)

Importancia de las características según Gradient Boosting:
![](images/clipboard-3667380716.png)
